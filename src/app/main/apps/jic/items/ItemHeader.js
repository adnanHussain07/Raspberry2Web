...
import { exportService, getProducts, rentUsersService } from 'app/auth/store/commonServices';
...
import { Permissions, StoreLabs } from 'app/auth/store/constants';
    ...
    mdDown ? <FuseScrollbars className="">
      ...
      <div className="flex flex-1 w-full items-center justify-between">
        ...
        <div className="flex flex-1 items-center justify-center px-12">
          ...
          {/* <div className='mx-8' >
            <MobileDatePicker
              label={i18next.t(`navigation:FROMDATE`)}
          ...
          <div className='mx-16' >
            <MobileDatePicker
              label={i18next.t(`navigation:TODATE`)}
              inputFormat="MM/dd/yyyy"
              value={valueTo}
