...
import DriverTableHead from './ItemTableHead';
...
function DriverTable(props) {
  ...
  const totalCount = useSelector(({ auth }) => auth.common.productsTotalCount ? auth.common.productsTotalCount : 0);
              ...
              return (
                ...
                >
                  ...
                  <TableCell className="p-4 md:p-16" component="th" scope="row" align='center'>
                    {n.original_storenumber ? getStoreName(n.original_storenumber) : ""}
                  </TableCell>
                  <TableCell className="p-4 md:p-16" component="th" scope="row" align='center'>
